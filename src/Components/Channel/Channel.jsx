...
const Channel = () => {
    ...
    useEffect(() => {
        ...
        const fetchMyChannel = async () => {
            try {
                const res = await axios.get("https://youtube-clone-iy0r.onrender.com/getChannel", {
        ...
        const fetchChannelById = async () => {
            try {
                const res = await axios.get(`https://youtube-clone-iy0r.onrender.com/getChannelById/${channelId}`, {
                    headers: { Authorization: `Bearer ${token}` },
                });
