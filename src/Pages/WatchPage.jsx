...
const WatchPage = () => {
    ...
    useEffect(() => {
        const fetchVideoDetails = async () => {
            try {
                setIsLoading(true);
                const res = await axios.get(`https://youtube-clone-iy0r.onrender.com/getVideo/${videoId}`, {
                    headers: {
        ...
        const fetchComments = async () => {
            try {
                const res = await axios.get(`https://youtube-clone-iy0r.onrender.com/getComments/${videoId}`);
    ...
    async function handleCommentSubmit(commentText) {
        try {
            ...
            const res = await axios.post(`https://youtube-clone-iy0r.onrender.com/addComment/${videoId}`, {
                comment: commentText
            },
                {
                    headers: {
    ...
    const handleDeleteComment = async (commentId) => {
        try {
            ...
            const err = await axios.delete(`https://youtube-clone-iy0r.onrender.com/deleteComment/${videoId}/${commentId}`, {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem('token')}`
                }
            });
    ...
    const handleEditComment = async (commentId) => {
        try {
            ...
            await axios.put(
                `https://youtube-clone-iy0r.onrender.com/editComment/${videoId}/${commentId}`,
                { text: editedText },
                {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem('token')}`
    ...
    const handleSubscribe = async () => {
        ...
        try {
            const res = await axios.put(`https://youtube-clone-iy0r.onrender.com/subscribe/${channelData.channelId}`, {}, {
                headers: {
    ...
    const handleLike = async () => {
        try {
            ...
            const res = await axios.put(`https://youtube-clone-iy0r.onrender.com/like/${videoId}`, {}, {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem('token')}`
                }
            });
    ...
    const handleDislike = async () => {
        try {
            ...
            const res = await axios.put(`https://youtube-clone-iy0r.onrender.com/dislike/${videoId}`, {}, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
        ...
        <div className="flex flex-col md:flex-row gap-6 p-4 bg-white text-black dark:bg-black dark:text-white min-h-screen ">
            ...
            <div className="lg:w-2/3 w-full">
                <video key={videoId} controls className="w-full rounded-xl aspect-video mb-4">
                    <source src={`https://youtube-clone-iy0r.onrender.com${videoData.videoFile}`} type="video/mp4" />
